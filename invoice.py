...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:avalan@localhost:5432/forsubscription'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
db = SQLAlchemy(app)

stripe.api_key = "sk_test_51PAm9tSAS5a6zI82ImcLj5lwcdn8Wb6ekr8BbHLISgVJ4vqUcZMKzkM8Z5Xy18pmf7JzFgLWpqgqGdcRQkkGyP2G00GviyQdmA"

# Email configuration
app.config['MAIL_SERVER'] = 'smtp.gmail.com'
app.config['MAIL_PORT'] = 465
app.config['MAIL_USERNAME'] = 'avalanr5@gmail.com'
app.config['MAIL_PASSWORD'] = 'ffddfhdavqrgfydx'
...
def checkout():
    ...
    if subscription_type == 'monthly':
        price_id = 'price_1PIQv8SAS5a6zI82d3uWN8pd'
    else:
        price_id = 'price_1PIQv8SAS5a6zI82d3uWN8pd'
...
def generate_invoice_pdf(transaction):
    ...
    logo_path = r"C:\Users\91902\Desktop\WhatsApp Image 2024-05-24 at 15.32.20_1082e995.jpg"
